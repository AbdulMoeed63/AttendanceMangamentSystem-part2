...
public class CEM4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("List Enrollments");

        jPanel1.setBackground(new java.awt.Color(0, 0, 102));

        jPanel2.setBackground(new java.awt.Color(102, 102, 0));

        enrollmenList.setBackground(new java.awt.Color(255, 51, 51));
        enrollmenList.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        enrollmenList.setForeground(new java.awt.Color(255, 255, 255));
        enrollmenList.setText("Click here to list all the enrollments");
        enrollmenList.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                enrollmenListActionPerformed(evt);
            }
        });
        ...
        jLabel1.setText("List Enrollments");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CEM4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
